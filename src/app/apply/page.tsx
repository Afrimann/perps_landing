            ...
            <ol className="mt-16 grid gap-5 sm:grid-cols-3">
              {steps.map((step, index) => (
                <Reveal key={step.title} delay={0.08 * index} as="li">
                  <div className="h-full rounded-2xl border border-white/10 bg-surface-900/60 p-7">
                    <span className="font-mono text-[0.68rem] tracking-[0.22em] text-accent-500 tabular">
                      0{index + 1}
                    </span>
        ...
        <section className="bg-paper-dim py-20 lg:py-24">
          <Container>
            <div className="mx-auto max-w-2xl text-center">
              ...
              <span className="mx-auto mt-7 block h-px w-24 bg-gradient-to-r from-transparent via-accent-500 to-transparent" />
